...
/*
** This function is a helper function of send_bit() and it serves to
** free 'g_message', outputs a error message, and exit the program when a kill()
** system call fails.
*/
void	error(void)
{
